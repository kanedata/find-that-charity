...
class Command(HTMLScraper):
    name = 'ccni_scrape'
    base_url = 'https://www.charitycommissionni.org.uk/charity-details/?regid={}&subid=0'
    ...
    def scrape_charity(self, regno):
        ...
        for f in r.html.find(".pcg-charity-details__fact"):
            ...
            value = int(f.find('.pcg-charity-details__amount', first=True).text.replace(",", ""))
            details[key] = value
