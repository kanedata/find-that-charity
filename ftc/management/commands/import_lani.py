...
class Command(LAECommand):
    ...
    source = {
        "title": "[Archived] Local authorites in Northern Ireland register",
        "description": "Local authorities in Northern Ireland This register was part of GOV.UK registers which was retired in 2021. [More information is available on gov.uk](https://www.data.gov.uk/dataset/a8f488fd-eaea-4176-92b0-6d0437b4d121/historical-gov-uk-registers).",
        "identifier": "lani",
        ...
        self.add_org_record(
            Organisation(
                **{
                    ...
                    "postalCode": None,
                    "telephone": None,
                    "alternateName": self.get_alternate_names(record.get("name")),
                    "email": None,
                    "description": None,
