...
urlpatterns = [
    ...
    path("type/<slug:orgtype>.html", views.org_search),
    path("type/<slug:orgtype>", views.org_search, name="orgid_type"),
    path(
    ...
    path("source/<str:source>.html", views.org_search),
    path("source/<str:source>", views.org_search, name="orgid_source"),
