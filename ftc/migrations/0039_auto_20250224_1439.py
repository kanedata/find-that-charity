# Generated by Django 5.0.4 on 2025-02-24 14:39
...
SELECT main.organisation_id,
    ...
    l.la_name::varchar(200) AS hq_la_name,
    l.rgn_code::varchar(200) AS hq_rgn_code,
    l.rgn_name::varchar(200) AS hq_rgn_name,
    l.uk_ctry_code::varchar(200) AS hq_ctry_code,
    l.uk_ctry_name::varchar(200) AS hq_ctry_name,
    l.hq_london AS hq_london,
    l.ward_code::varchar(200) AS hq_ward_code,
    l.ward_name::varchar(200) AS hq_ward_name,
