...
class Migration(migrations.Migration):
    dependencies = [
        ("ftc", "0033_remove_organisation_ftc_organis_linked__bff241_gin_and_more"),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name="areas_list",
            field=ArrayField(models.TextField(blank=True)),
        ),
        migrations.AddField(
            model_name="charitydata",
            name="causes_list",
        ...
        migrations.RunSQL(
            sql=[
                'DROP MATERIALIZED VIEW "ftc_charitydata"',
                f"""
