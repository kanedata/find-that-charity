...
from findthatcharity.apps.ftc.management.commands.import_casc import (
    Command as CASCCommand,
)
from findthatcharity.apps.ftc.management.commands.import_ror import (
    Command as RORCommand,
)
