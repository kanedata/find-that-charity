...
from api.schema import Organisation as OrganisationOut, Source as SourceOut
from api.filters import OrganisationFilter, OrganisationIn
from ftc.models import Organisation
from ftc.query import get_organisation as query_organisation, get_linked_organisations as query_linked_organisations
...
@api.get("/organisations/{organisation_id}", response={200: OrganisationOut, 404: ResultError})
...
@api.get("/organisations/{organisation_id}/linked", response={200: List[OrganisationOut], 404: ResultError})
...
@api.get("/organisations/{organisation_id}/source", response={200: SourceOut, 404: ResultError})
