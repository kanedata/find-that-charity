...
select g.data->>'id' as "grant_id",
    ...
    g.data->'recipientOrganization'->0->>'id' as "recipientOrganization_canonical_id",
    g.data->'recipientOrganization'->0->>'name' as "recipientOrganization_canonical_name",
    ...
    g.data->'fundingOrganization'->0->>'id' as "fundingOrganization_canonical_id",
    g.data->'fundingOrganization'->0->>'name' as "fundingOrganization_canonical_name",
    g.additional_data->>'TSGFundingOrgType' as "fundingOrganization_type",
    coalesce(
        g.data->'grantProgramme'->0->>'title',
        g.data->'grantProgramme'->0->>'Name',
        g.data->'grantProgramme'->0->>'description',
        g.data->'grantProgramme'->0->>'code'
    ) as "grantProgramme_title",
