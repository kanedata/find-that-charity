    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipientOrganization_id', ftc.models.orgid.OrgidField(db_index=True, max_length=200)),
                ('recipientOrganization_name', models.CharField(db_index=True, max_length=255)),
                ('fundingOrganization_id', ftc.models.orgid.OrgidField(db_index=True, max_length=200)),
                ...
                ('spider', models.CharField(db_index=True, default='360g', max_length=200)),
                ('scrape', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='ftc.scrape')),
            ],
        ),
    ]
